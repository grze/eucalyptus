...
import com.eucalyptus.sdb.ErrorResponse;
 ...
 */
public class SimpleDBErrorHandler extends ErrorHandlerSupport {
  private static final Logger LOG = Logger.getLogger( SimpleDBErrorHandler.class );
  private static final String INTERNAL_FAILURE = "InternalFailure";  //TODO:GEN2OOLS: Verify / replace default error code for service

  public SimpleDBErrorHandler( ) {
    super( LOG, SimpleDBQueryBinding.SIMPLEDB_DEFAULT_NAMESPACE, INTERNAL_FAILURE );
  }
  ...
  protected BaseMessage buildErrorResponse( final String correlationId,
    ...
    final com.eucalyptus.sdb.Error error = new com.eucalyptus.sdb.Error( );
